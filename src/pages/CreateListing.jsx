      ...
      <form>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:border-gray-600"
          />
        </div>
        <button
          type="submit"
